...
BinomialBSTreeRichardson::BinomialBSTreeRichardson(double S, double K, double T, double sigma, double r, double q, int n, bool call, bool eu) : m_S0(S), m_K(K), m_T(T), m_sigma(sigma), m_r(r), m_q(q), N(n), Call(call), Eu(eu)
{
	bt1 = new BinomialBSTree(S, K, T, sigma, r, q, n, call, eu);
	bt2 = new BinomialBSTree(S, K, T, sigma, r, q, n/2, call, eu);
}
