...
BinomialTree::BinomialTree(double S, double K, double T, double sigma, double r, double q, int n, bool call) :  m_S0(S), m_K(K), m_T(T), m_sigma(sigma), m_r(r), m_q(q), N(n), Call(call)
{
	dt = m_T / N;
