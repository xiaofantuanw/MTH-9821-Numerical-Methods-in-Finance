...
public:
	...
	std::tuple<vec, uint> sor_banded(const vec& early_exercise, const mat& A, const vec& b, vec x, const double tolerance, const double omega, const int lower_bandwidth, const int upper_bandwidth, const StoppingCriterion criterion);
